...
client = groq.Groq(api_key="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")
#or
...
while True:
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            {"role": "system", "content": "You assist the user on how to improve their coding skills."},
